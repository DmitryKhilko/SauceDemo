...
public class ExtendedTest extends BaseTest {
    ...
    public void itemCountInCart(ITestContext context) {
        loginPage.open();
        ...
        log.debug("Тест " + context.getAttribute("testName") + ": сравнить ожидаемое количеству товара в корзине с фактическим");
        ...
        log.debug("Тест " + context.getAttribute("testName") + ": сравнить ожидаемое количеству товара на иконке корзины с фактическим");
